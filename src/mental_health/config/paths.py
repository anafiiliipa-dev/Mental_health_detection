...
# Phase 11, remaining slices: robustness (typos/casing perturbations),
# bias slicing (subgroup evaluation) and the DistilBERT fine-tune —
# reports live alongside model_comparison.csv (classical candidates) and
# under TRANSFORMER_REPORTS_DIR (DistilBERT), regenerated by their own
# runner scripts, not by train.py's main run().
